...
class SetCriterion(nn.Module):
    ...
    def loss_boxes(self, outputs, targets, indices, num_boxes):
        ...
        # 计算giou损失
        '''generalized_box_iou()方法返回的是所有预测框与所有GT的GIoU，比如预测框有N个，GT有M个，
        那么返回结果就是NxM个GIoU。而如 loss_boxes(i) 图中所示，我们预先对匹配的预测框和GT进行了排列(src_boxes和target_boxes取出来已经有了对应关系)，
        即N个预测框中的第1个匹配M个GT中的第1个，N中第2个匹配M中第2个，..，N中第i个匹配M中第i个，
        于是我们要取相互匹配的那一项来计算loss。'''
